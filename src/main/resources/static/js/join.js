function checkUserNickExist() {
    ...
    $.ajax({
        url : "/user/checkUserNickNameExist?user_nickname=" + user_nickname,
        type : "GET",
        dataType : "text",
...
function checkUserIdExist() {
    ...
    $.ajax({
        url : "/user/checkUserIdExist?user_id=" + user_id,
        type : "GET",
        dataType : "text",
        success : function(result) {
            if(result.trim() == "true") {
...
function checkEmailExist(path) {
    ...
    $.ajax({
        url : path + "user/checkUserEmailExist?user_email=" + user_email,
        type : "GET",
        dataType : "text",
        success : function(result) {
            if(result.trim() == "true") {
    ...
    new daum.Postcode(
        {
            oncomplete : function(data) {
                ...
                if (data.userSelectedType === 'R') {
                    ...
                    document.getElementById("reference_addr").value = extraAddr;

                } else {
                    document.getElementById("reference_addr").value = '';
                }
